    	...
    	<div id="inner-content">
    		...
    		<table border=1 width=550 style="background:white;margin-top:50px;">
    			...
    			<tr onclick="location.href='adminQuestionAnswer'" style="cursor:pointer;">
    				<td width=50>1</td>
    				<td width=250>검색되는 페이지가 너무 느립니다</td>
    				<td width=50>nam</td>
    				<td width=80>2019-12-16</td>
    				<td width=40><input type="button" value="확인"></td>
    			</tr>
    			<tr onclick="location.href='adminQuestionAnswer'" style="cursor:pointer;">
    				<td width=50>2</td>
    				<td width=250>약 검색이 제대로 되지 않습니다</td>
    				<td width=50>kyo</td>
    				<td width=80>2019-12-09</td>
    				<td width=40><input type="button" value="확인"></td>
    			</tr>
    			<tr onclick="location.href='adminQuestionAnswer'" style="cursor:pointer;">
    				<td width=50>3</td>
    				<td width=250>추천수가 올라가지 않아요</td>
    				<td width=50>kim</td>
    				<td width=80>2019-11-27</td>
    				<td width=40><input type="button" value="확인"></td>
    			</tr>
    			<tr onclick="location.href='adminQuestionAnswer'" style="cursor:pointer;">
    				<td width=50>4</td>
    				<td width=250>게시글이 연속으로 올라갑니다</td>
    				<td width=50>gun</td>
    				<td width=80>2019-10-10</td>
    				<td width=40><input type="button" value="확인"></td>
    			</tr>
    		</table>
    		<button>저장</button>
